...
import { Descriptions, Card, Table, Tag, Typography, Divider } from 'antd'; // Space убран
...
export const CompanyPage = () => {
  ...
  // (Копирую только начало, чтобы не дублировать весь файл, логика рендера не менялась)
