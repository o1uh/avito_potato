Текущий статус проекта: **v0.3.0 — Реализованы Компании, Команды и Банковские реквизиты**.
Готовы модули `Auth` (JWT, регистрация), `References` (кэширование в Redis), `Users` (профиль), `Companies` (проверка ИНН) и `Team Management` (управление сотрудниками).
