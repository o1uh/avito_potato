Текущий статус проекта: **v1.1.0 — Внутренняя система уведомлений и финальная сборка сервера**.
...
- `Communication` (NEW): Система внутренних уведомлений (хранение в БД + Email), REST API для списка уведомлений и статуса прочтения.
