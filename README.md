Текущий статус проекта: **v0.4.0 —  Реализованы Каталог товаров, Полнотекстовый поиск и Управление компаниями**.
Готовы модули `Auth` (JWT, регистрация), `References` (кэширование в Redis), `Users` (профиль), `Companies` (проверка ИНН), `Team Management` (управление сотрудниками) и `Catalog` (управление товарами и поиск).
