Текущий статус проекта: **v1.0.0 —  Интеграция с Банком и полноценная адресная система**.
Готовы модули:
...
- `Finance` (NEW): Эскроу-счета, транзакции, хранимые процедуры БД для атомарности, расчет комиссий и интеграция с Банком (Вебхуки/Точка).
