Текущий статус проекта: **v0.2.0 — Реализовано ядро, справочники и авторизация**.
Готовы модули `Auth` (JWT, регистрация), `References` (кэширование в Redis), `Users` (профиль), инфраструктура и базовые сервисы.
...
### Шаг 6: Просмотр БД (Prisma Studio)
