Текущий статус проекта: **v1.3.0  — Добавлен Frontend (Авторизация, Профиль, Сотрудники, Нетворкинг)**.
...
- `Catalog`(NEW): Витрина товаров с фильтрацией (Elasticsearch), пагинацией и умной галереей (общие фото + фото вариантов).
- `Product Wizard`(NEW): Многошаговая форма создания товара с динамическими вариантами (SKU), автогенерацией артикулов и Drag-n-Drop загрузкой изображений.
